...
import { MapPin, Sparkles, PackageCheck, ShieldCheck } from "lucide-react";
...
export const BrandPillars = () => {
  ...
  return (
    <section
      id="brand-pillars"
      className="py-14 bg-[#F5F0EA] border-y border-[#E8DFD3]"
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-2xl mx-auto mb-12">
          ...
          <p className="text-sm sm:text-base text-[#5C554C] mt-2.5">
            Crafted with passion using honest ingredients, fair pricing, and
            pure botanical nourishment for your everyday bath ritual.
          </p>
        </div>
