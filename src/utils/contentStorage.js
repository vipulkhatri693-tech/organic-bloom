...
export const getProducts = () => {
  ...
  const seeded = JSON.parse(JSON.stringify(SOAP_PRODUCTS));
  try {
...
export const slugifyProductId = (name, existingIds) => {
  const base =
    name
      .trim()
      .toLowerCase()
