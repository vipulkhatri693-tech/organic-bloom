...
import { Sparkles, CheckCircle2, ShieldAlert, Heart, Flame, Droplets } from 'lucide-react';

export const ColdProcessRitual: React.FC = () => {
  const [activeStepIndex, setActiveStepIndex] = useState(0);

  const activeStep = CRAFT_STEPS[activeStepIndex];

  return (
    <section id="craft-ritual" className="py-16 sm:py-24 bg-[#FAF7F2] border-t border-[#E8DFD3]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-2xl mx-auto mb-14">
          ...
          <p className="text-sm sm:text-base text-[#5E574E] mt-3">
            We gently melt our pure natural plant base over low heat and blend in authentic raw herbs, botanical extracts, and nourishing essential oils. Zero harsh chemicals, zero synthetic hardeners — pure nourishment for your skin.
          </p>
        </div>
              ...
              <div className="flex items-center justify-between mb-1">
                <span
                  className={`text-xs font-bold tracking-wider ${
                    activeStepIndex === idx ? 'text-[#E3B873]' : 'text-[#885A2C]'
                  }`}
                >
                  PHASE {step.step}
                </span>
                <span
                  className={`text-[10px] px-2 py-0.5 rounded-full ${
                    activeStepIndex === idx ? 'bg-[#3A5643] text-white' : 'bg-[#E3D8C8] text-[#554E44]'
                  }`}
                >
                  {step.timeframe}
                </span>
          ...
          <div className="lg:col-span-7 space-y-5">
            ...
            <div className="p-4 rounded-xl bg-[#FAF7F2] border border-[#E3D9CC] flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-[#595247] mt-0.5">{activeStep.detail}</p>
              </div>
            </div>
            ...
            <div className="p-5 rounded-xl bg-[#EAF3EB] border border-[#C6DCB8]">
              ...
              <ul className="space-y-2 text-xs text-[#3E5243]">
                <li className="flex items-center gap-2">
                  ...
                  <span>Pure natural base melted gently without chemical lye or industrial fumes</span>
                </li>
                <li className="flex items-center gap-2">
                  <span className="text-[#263E2E] font-bold">✓</span>
                  <span>Direct infusion of raw active herbs: Rice Milk, Bamboo Charcoal, &amp; 18 Ayurvedic Herbs</span>
                </li>
                <li className="flex items-center gap-2">
                  <span className="text-[#263E2E] font-bold">✓</span>
                  <span>100% vegetable glycerin retained for immediate barrier hydration &amp; baby-soft feel</span>
                </li>
                <li className="flex items-center gap-2">
                  <span className="text-[#263E2E] font-bold">✓</span>
                  <span>Handcrafted in small batches with 100% natural herbs &amp; botanical powders</span>
                </li>
              </ul>
            </div>
            ...
            <div className="p-5 rounded-xl bg-[#F6ECEB] border border-[#ECCDC9]">
              ...
              <ul className="space-y-2 text-xs text-[#6F433E]">
                <li className="flex items-center gap-2">
                  ...
                  <span>Natural glycerin is stripped away in industrial plants to sell in luxury creams</span>
                </li>
                <li className="flex items-center gap-2">
                  <span className="text-[#96372D] font-bold">✗</span>
                  <span>Synthetic detergent pellets (SLS/SLES) extruded under heavy pressure in 30 seconds</span>
                </li>
                <li className="flex items-center gap-2">
                  <span className="text-[#96372D] font-bold">✗</span>
                  <span>Harsh chemical hardeners and artificial scents that irritate sensitive skin</span>
                </li>
                <li className="flex items-center gap-2">
                  <span className="text-[#96372D] font-bold">✗</span>
                  <span>Single-use plastic wrappers contributing to non-biodegradable waste</span>
                </li>
              </ul>
            </div>
          </div>
