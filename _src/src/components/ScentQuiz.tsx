...
import { X, Sparkles, ArrowRight, ArrowLeft, Check, RotateCcw, Droplets, Sun, Layers, Flower2, Zap, Trees, HeartHandshake, Milk, Cloud, Brush } from 'lucide-react';
...
export const ScentQuiz: React.FC<ScentQuizProps> = ({
  ...
  const [resultProduct, setResultProduct] = useState<SoapProduct | null>(null);
        ...
        {!resultProduct ? (
          <div>
            ...
            <div className="mb-6">
              ...
              <p className="text-xs sm:text-sm text-[#635B50] mt-1.5">{currentQ.subtitle}</p>
            </div>
                ...
                return (
                  ...
                  >
                    <div className="w-10 h-10 rounded-lg bg-[#FAF7F2] border border-[#DDD3C2] flex items-center justify-center shrink-0 group-hover:scale-105 transition-transform">
                      {iconMap[opt.iconName] || <Sparkles className="w-5 h-5 text-[#263E2E]" />}
                    </div>
          ...
          <div className="animate-fade-in text-center">
            ...
            <div className="mt-6 p-4 rounded-xl bg-white border border-[#DDD3C2] flex flex-col sm:flex-row items-center gap-5 text-left shadow-xs">
              ...
              <div className="flex-1">
                <div className="flex items-center gap-2 mb-1">
                  ...
                  <span className="text-xs font-bold text-[#1C2C20]">₹{resultProduct.price}</span>
                </div>
            ...
            <div className="mt-4 p-3 rounded-lg bg-[#F3ECE0] text-xs text-[#50483E] text-left">
              <strong className="font-semibold text-[#263E2E]">Why this soap was chosen:</strong>{' '}
              Handcrafted with Melt &amp; Pour botanical herbs tailored to your skin goal. Free from sulfates, parabens, or synthetic fragrance.
            </div>
