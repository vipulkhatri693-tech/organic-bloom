...
const firebaseConfig = {
  apiKey: import.meta.env.VITE_FIREBASE_API_KEY || 'AIzaSyB4nKQZlzGnvS7XU8wSfbQoCTGhhddxz_k',
  authDomain: import.meta.env.VITE_FIREBASE_AUTH_DOMAIN || 'organic-bloom-8995c.firebaseapp.com',
  projectId: import.meta.env.VITE_FIREBASE_PROJECT_ID || 'organic-bloom-8995c',
  storageBucket: import.meta.env.VITE_FIREBASE_STORAGE_BUCKET || 'organic-bloom-8995c.firebasestorage.app',
  messagingSenderId: import.meta.env.VITE_FIREBASE_MESSAGING_SENDER_ID || '667949373357',
  appId: import.meta.env.VITE_FIREBASE_APP_ID || '1:667949373357:web:1df984411bc1fdb1273324',
};
...
export const getRecaptchaVerifier = (containerId: string): RecaptchaVerifier => {
  if (!auth) {
    throw new Error('Firebase is not configured. Please contact the site owner.');
  }
...
export const resetRecaptcha = (containerId?: string): void => {
  const w = window as any;
